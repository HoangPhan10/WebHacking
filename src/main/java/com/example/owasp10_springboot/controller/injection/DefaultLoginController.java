...
public class DefaultLoginController extends AbstractController {
    ...
    private static ConcurrentHashMap<String, UserBug> userLoginHistory = new ConcurrentHashMap<>();
    ...
    private UserBug getUser(String userid) {
        UserBug admin = userLoginHistory.get(userid);
        if (admin == null) {
            UserBug newAdmin = new UserBug();
